...
const services = [
  ...
  },
  {
    ...
    fullDesc: `This Mentor's journey is a testament to reinvention and purpose. Once a disciplined leader in the defense forces, they now bring the same precision and resilience to Google's innovation hubs. As a personal mentor, they guide individuals from their 20s to their 30s — students, entrepreneurs, and future visionaries — helping them uncover their true purpose and lead with unwavering confidence. Each weekend session is a bridge connecting past discipline with future ambition, creating a space where every step forward is purposeful, every decision is bold, and every dream is within reach. Your potential is limitless — this mentor will help you prove it.`,
    pricing: [
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="text-[#E5E4E2]/60 text-sm leading-relaxed mb-4">
                {service.desc}
              </p>
